...
\begin{thebibliography}
    ...
    \bibitem{MG} Goossens, M., Mittelbach, F., Samarin, A LaTeX Companion, 
    \bibitem{HK} Kopka, H., Daly P.W., A Guide to LaTeX, Addison-Wesley, 
    \bibitem{Pan} Pan, D., A Tutorial on MPEG/Audio Compression, IEEE 
\end{thebibliography}
