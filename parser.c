...
{
       0,    63,    63,    64,    67,    73,    76,    79,    82,    85,
      88,    91,    95,    96,    97,   102,   103,   104,   105,   108,
     111,   115,   118,   121,   124,   127,   134,   139,   142,   147,
     151,   154,   155,   158,   158
};
#endif
...
{
  "$end", "error", "$undefined", "T_TITLE", "T_MAKETITLE", "T_TEXTBF",
  "T_TEXTIT", "T_BEGIN_DOC", "T_END_DOC", "T_BEGIN_ITEMIZE",
  "T_END_ITEMIZE", "T_ITEM", "T_INCLUDEGRAPHICS", "T_CITE", "T_BEGIN_BIB",
  "T_END_BIB", "T_BIB_ITEM", "T_MATH", "T_LBRACE", "T_RBRACE",
  "T_LBRACKET", "T_RBRACKET", "T_NEWLINE", "T_SPACE", "T_P", "T_DOLLAR",
  "$accept", "stmt_list", "stmt", "text_list", "text", "list", "item_list",
  "item", "freespace_list", "freespace", YY_NULLPTR
};
#endif
...
{
      45,   -14,   -27,     7,     8,   -27,   -27,    -7,    19,    20,
      -7,    -7,    21,    -1,   -27,   -27,   -27,   -27,     5,   -27,
      66,   -27,   -27,    16,    23,    31,   -27,   -27,    54,   -27,
      40,    42,    -7,    -7,    49,    29,   -27,   -27,    87,    89,
     -27,    55,    59,    61,    57,   -27,    -7,   -27,   -27,    63,
      65,    67,   -27,   -27,   -27,   -27,   -27,   -27,   -27,   -27,
      22,   -27,   -27,    73,   -27,   -27,    -7,    -7
};
...
{
       0,     0,     5,     0,     0,     6,     7,     0,     0,     0,
       0,     0,     0,     0,    12,    13,    21,    20,     0,     3,
       0,    18,    24,     0,     0,     0,    33,    34,     0,    32,
       0,     0,     9,    10,     0,     0,     1,     2,     0,     0,
      17,     0,     0,     0,     0,    30,     0,    28,    31,     0,
       0,     0,    19,    14,    15,    16,     4,    22,    23,    29,
       0,     8,    25,     0,    26,    27,     0,    11
};
...
{
     -27,   -27,    69,   -27,     4,   -25,   -27,    25,   -10,   -26
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,    18,    19,    20,    21,    22,    46,    47,    28,    29
};
...
{
      32,    33,    48,    45,    23,    36,    48,    48,     1,     2,
       3,     4,     5,     6,     7,    26,    27,     8,     9,    10,
      11,    12,    13,    35,    40,    24,    25,    14,    15,    16,
      17,     7,    64,    44,    48,    45,    60,    30,    31,    34,
      41,    48,    54,    55,    26,    27,    52,    42,     1,     2,
       3,     4,     5,     6,     7,    43,    67,     8,     9,    10,
      11,    12,    13,     7,    49,    44,    50,    14,    15,    16,
      17,     3,     4,    51,    56,     7,    26,    27,    57,     9,
      58,    59,    61,    13,    62,    65,    63,    37,    38,    39,
      16,    17,     3,     4,     3,     4,     7,    66,     7,     0,
       9,     0,     9,     0,    13,     0,    13,     0,     0,    53,
       0,    16,    17,    16,    17
};

static const yytype_int8 yycheck[] =
{
      10,    11,    28,    28,    18,     0,    32,    33,     3,     4,
       5,     6,     7,     8,     9,    22,    23,    12,    13,    14,
      15,    16,    17,    24,    20,    18,    18,    22,    23,    24,
      25,     9,    10,    11,    60,    60,    46,    18,    18,    18,
      24,    67,    38,    39,    22,    23,    17,    24,     3,     4,
       5,     6,     7,     8,     9,    24,    66,    12,    13,    14,
      15,    16,    17,     9,    24,    11,    24,    22,    23,    24,
      25,     5,     6,    24,    19,     9,    22,    23,    19,    13,
      19,    24,    19,    17,    19,    60,    19,    18,    22,    23,
      24,    25,     5,     6,     5,     6,     9,    24,     9,    -1,
      13,    -1,    13,    -1,    17,    -1,    17,    -1,    -1,    22,
      -1,    24,    25,    24,    25
};
...
static const yytype_uint8 yystos[] =
{
      ...
      14,    15,    16,    17,    22,    23,    24,    25,    27,    28,
      29,    30,    31,    18,    18,    18,    22,    23,    34,    35,
      18,    18,    34,    34,    18,    24,     0,    28,    22,    23,
      30,    24,    24,    24,    11,    31,    32,    33,    35,    24,
      24,    24,    17,    22,    30,    30,    19,    19,    19,    24,
      34,    19,    19,    19,    10,    33,    24,    34
};
...
#line 67 "parser.y" /* yacc.c:1646  */
    {
          len = strlen((yyvsp[-1].str));
          title = (char*) malloc( (len+1) * sizeof(char) );
          strncpy(title, (yyvsp[-1].str), len);
          title[len] = '\0';
        }
...
#line 91 "parser.y" /* yacc.c:1646  */
    {
          ...
          full_reference((yyvsp[-3].str), (yyvsp[-1].str));
        }
...
#line 104 "parser.y" /* yacc.c:1646  */
    { (yyval.str) = concat(2, (yyvsp[-1].str), (yyvsp[0].str)); }
...
#line 108 "parser.y" /* yacc.c:1646  */
    {
          (yyval.str) = concat(3,"<span class=\"MathJax\">", (yyvsp[-1].str), "</span>");
        }
...
#line 118 "parser.y" /* yacc.c:1646  */
    {
          (yyval.str) = concat(3, "<strong>", (yyvsp[-1].str), "</strong>");
        }
...
#line 121 "parser.y" /* yacc.c:1646  */
    { 
          (yyval.str) = concat(3, "<em>", (yyvsp[-1].str), "</em>"); 
        }
...
#line 139 "parser.y" /* yacc.c:1646  */
    {
              (yyval.str) = concat(2, (yyvsp[-2].str), (yyvsp[0].str));
            }
